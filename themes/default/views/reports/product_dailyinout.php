                    ...
                    <table id="tbstock" class="table table-condensed table-bordered table-hover table-striped" >
                        ...
                        <tbody>
							...
							<tr class="rows">
                                ...
                                <td><ul class="enlarge">
                                        <li>
                                            <img src="<?= base_url()?>/assets/uploads/thumbs/<?=$row->image ?>"  class="img-responsive" style="width:50px;"/>
                                            <span>
                                                <a href="<?= base_url()?>/assets/uploads/thumbs/<?=$row->image ?>" data-toggle="lightbox">
                                                    <img src="<?= base_url()?>/assets/uploads/thumbs/<?=$row->image ?>"  style="width:150px; z-index: 9999999999999;" class="img-thumbnail"/>
                                                </a>
                                            </span>
                                        </li>
                                    </ul>
