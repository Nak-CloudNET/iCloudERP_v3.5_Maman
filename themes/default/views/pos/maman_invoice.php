            ...
            <div class="text-center">
                ...
                <table class="table-condensed receipt no_border_btm" style="width:100%;">
                    ...
                    if(is_array($rows)){
                        ...
                        foreach ($rows as $row) {
                            ...
                            echo '	<td class="text-center bigger"  style="text-align:center; width:100px !important;">' . (($row->unit_price)==0? $free:$this->erp->formatMoney($row->unit_price)) . '</td>';
                            ...
                            echo '<td class="text-right bigger">' . (($row->subtotal) == 0 ? $free : $this->erp->formatMoney($row->subtotal)) . '</td>';
                ...
                <table class="received" style="width:100%;margin-top: 5px;">
                    ...
                    if($payments){
                        ...
                        //echo ($payment->pos_paid_other != null ? $payment->pos_paid_other/$exchange_rate->rate : 0);
                        //$this->erp->print_arrays($inv->grand_total,'___',$pos_paid,"__",$pos_paid_other);
                    }

                    //$this->erp->print_arrays($pos_paidd);
