            ...
            <div class="text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 text-center company">
                        <h3 style="font-family: 'Arial Black';"><b><?= strstr($biller->company, '(', true); ?></b></h3>
                ...
                <table class="table-condensed receipt no_border_btm" style="width:100%;">
                    ...
                    if(is_array($rows)){
                        ...
                        foreach ($rows as $row) {
                            ...
                            echo '<td class="text-right" style="font-size: 13px !important">' . (($amounts)==0? $free:$this->erp->formatMoney($amounts)) . '</td>';
