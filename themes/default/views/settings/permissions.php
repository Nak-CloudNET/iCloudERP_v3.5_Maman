									   ...
									   <div class="container-fluid ">
											...
											<div class="col-md-6">
													<input type="checkbox" value="1" id="products-count_stocks" class="checkbox"
														...
														for="products-count_stocks" class="padding05"><?= lang('products-count_stocks') ?></label>
											</div>
                                ...
                                <td>
                                  ...
                                  <div class="col-md-4">                                    
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="checkbox" value="1" class="checkbox" id="product_report_product_value"
                                               name="product_report-product_value" <?php echo $p->{'product_report-product_value'} ? "checked" : ''; ?>><label
                                                for="product_report_product_value" class="padding05"><?= lang('product_report_product_value') ?></label><br/>
                                        ...
                                        for="reports-product_top_sale" class="padding05"><?= lang('reports-product_top_sale') ?></label><br/>
                                  </div>
                                  </div>
