<script type="text/javascript">
    <?php if ($this->session->userdata('remove_q2')) { ?>
    ...
    if (__getItem('slsaleman')) {
        __removeItem('slsaleman');
    }
    ...
    $(document).ready(function () {
        ...
        if (test2 == '1') {
            ...
            __removeItem(['quitems', 'qudiscount', 'qutax2', 'qutax2', 'qushipping', 'qushipping', 'quref',
                'quref', 'quwarehouse', 'qunote', 'quinnote', 'qucustomer', 'qucurrency', 'qudate',
                'qustatus', 'qubiller'
            ]);
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= get_dropdown_project('biller', 'qubiller') ?>
                            </div>
                        </div>
