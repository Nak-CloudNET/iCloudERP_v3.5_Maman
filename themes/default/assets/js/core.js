...
$(document).ready(function() {
	...
	$('body').on('click', '.report_invoice_links td:not(:first-child, :nth-child(2), :last-child)', function() {
        $('#myModal').modal({remote: site.base_url + 'sales/modal_views/' + $(this).parent('.report_invoice_links').attr('id')});
        $('#myModal').modal('show');
        //window.location.href = site.base_url + 'sales/view/' + $(this).parent('.invoice_link').attr('id');
    });
